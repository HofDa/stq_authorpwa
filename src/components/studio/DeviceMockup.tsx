...
export function DeviceMockup({
  ...
  return (
    <div className="stq-device-mockup">
      <div className="stq-device-mockup__label">
        <strong>{label}</strong>
        {detail && <span className="stq-device-mockup__detail">{detail}</span>}
      </div>
      <div
        className="stq-ios-device stq-device-mockup__shell"
        style={{
          width,
          height,
        }}
      >
        <div className="stq-ios-device__island" aria-hidden />
        <div className="stq-ios-device__status" aria-hidden>
          <span>9:41</span>
          <div className="stq-ios-device__status-icons">
