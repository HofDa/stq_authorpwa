...
export type EditorTextKey =
  ...
  | 'rrr.editor.module.safeDialToleranceLabel'
  | 'rrr.editor.module.safeDialToleranceHint'
  | 'rrr.editor.module.safeDialHoldLabel'
  | 'rrr.editor.module.safeDialHoldHint'
  | 'rrr.editor.module.safeDialHoldExpertLabel'
  | 'rrr.editor.module.proximityRadiusLabel'
  | 'rrr.editor.module.proximityRadiusHint'
  | 'rrr.editor.balance.startLat'
  | 'rrr.editor.balance.startLng'
  | 'rrr.editor.balance.targetLat'
  | 'rrr.editor.balance.targetLng'
  | 'rrr.editor.balance.radius'
  | 'rrr.editor.balance.radiusHint'
  | 'rrr.editor.balance.timeLimitMs'
  | 'rrr.editor.balance.maxTiltDegrees'
  ...
  | 'rrr.editor.card.balanceTitle'
  | 'rrr.editor.card.balanceDescription'
  | 'rrr.editor.card.compassTitle'
  | 'rrr.editor.card.compassDescription'
  | 'rrr.editor.card.safeDialTitle'
  | 'rrr.editor.card.safeDialDescription'
