...
export type EditorTextKey =
  ...
  | 'rrr.editor.compass.liveEnable'
  | 'rrr.editor.compass.liveStarting'
  ...
  | 'rrr.editor.morse.aria'
  | 'rrr.editor.morse.eyebrow'
  | 'rrr.editor.morse.set'
  | 'rrr.editor.morse.missing'
  | 'rrr.editor.morse.audioReady'
  | 'rrr.editor.morse.syntheticAudio'
  | 'rrr.editor.morse.pattern'
  | 'rrr.editor.morse.patternPlaceholder'
  | 'rrr.editor.morse.patternHint'
  | 'rrr.editor.morse.shortAudio'
  | 'rrr.editor.morse.shortAudioPlaceholder'
  | 'rrr.editor.morse.longAudio'
  | 'rrr.editor.morse.longAudioPlaceholder'
  | 'rrr.editor.morse.audioHint'
  | 'rrr.editor.morse.warning'
  ...
  | 'rrr.editor.card.morseTitle'
  | 'rrr.editor.card.morseDescription'
  ...
  | 'rrr.editor.summary.morsePattern'
  | 'rrr.editor.summary.morseAudio'
