...
/**
 * Decode a Google-style encoded polyline back into `{ lat, lng }` pairs.
 * Inverse of `encodePolyline`. Returns an empty array for an empty string.
 */
export function decodePolyline(value: string): { lat: number; lng: number }[] {
